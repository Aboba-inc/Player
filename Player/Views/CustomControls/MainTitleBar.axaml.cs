...
namespace Player.Views.CustomControls
{
    public partial class MainTitleBar : UserControl
    {
        ...
        AvaloniaProperty.Register<MainTitleBar, bool>(nameof(IsSeamless));
        ...
        public static new readonly StyledProperty<IImmutableSolidColorBrush> BackgroundProperty =
        AvaloniaProperty.Register<MainTitleBar, IImmutableSolidColorBrush>(nameof(Background));
        ...
        public IImmutableSolidColorBrush Background
        {
            ...
            set
            {
                ...
                titleBarBackground.Background = value;
            }
        }
